...
var
  debug   = require('debug')('routes-builder:express.build'),
...
//-------------------- BEGIN MODULE EXPORT -------------------
module.exports = function(app_object, routes_map) {
  app = app_object;
  map = routes_map;
  ...
  app.routes_builder.setupComplete(app);
  console.log('Routes creation complete');
};
//--------------------- END MODULE EXPORT --------------------